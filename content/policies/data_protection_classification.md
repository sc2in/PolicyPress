---
title: Data Protection and Classification Policy
description: The SC2 Data Protection and Classification Policy
summary: This document outlines universal standards to facilitate data protection and further defines data protection, data classification levels and standards for data processing.
date: 2025-04-16
weight: 2
taxonomies:
  SCF:
...
- Electronic storage media, including phones and tablets.
- Electronic systems collectively known as "information systems."

## Data Protection

**Data protection** involves:

- Defining and protecting all information assets. "Information assets" is an all-inclusive term that includes data, knowledge and data sets, and will be referred to collectively as "data."
...
All sensitive information will be encrypted at rest using a tool that requires a secondary authentication mechanism (not integrated into the operating system) to access the information.
...
- Data owners must review the data retention schedule maintained by the legal department to determine if information must be retained and for how long.
- Data owners are responsible for knowing what confidential information they own and where it is stored.


## Data Custodians

The **data custodian** is the individual or group who is responsible for the maintenance and protection of data assets.

The data custodian of electronic information may be the data owner and/or the IT department.

- For electronic information, the data custodian’s duties may include:
  - Performing information backups
  - Implementing technical security controls as directed by the data owner
  - Restoring information from backups and fulfilling requirements set in the other policies
- The data custodian of nonelectronic information is usually the data owner.

## Data Storage

Physical media containing confidential information will be stored in an area or container that can be locked to prevent authorized access.

Confidential information will not be stored at a third-party location unless authorized and provided by the data owner. Exceptions will be managed in accordance with this organization’s Control Exception Policy. Confidential information that has been approved for storage at a third-party’s location must be protected by defined controls.

## Confidential Asset Protection

Confidential information assets are classified and labeled as confidential. For example:

- All instances in which confidential data is displayed on a screen or otherwise presented to a computer user must involve a label indicating the information asset’s confidential classification.
- In teleconferences and telephone calls where confidential information is to be discussed, a determination must be made that all parties to the discussion are authorized to receive the confidential information.
...
Exceptions to this policy shall be managed and maintained by following the processes outlined by this organization’s Configuration Management and Change Management Policy and Control Exception Policy.

## Classification Matrix

|Classification Level | Examples |
|---------------------|----------|
| Public | <ul><li>Press releases</li><li>Building names</li><li>Maps</li></ul> |
| Sensitive Data | <ul><li>Financial forecasting data prior to public release</li><li>Business plans</li><li>Human resource information, such as policies and benefits</li><li>Need to know</li></ul> |
| Confidential Data | <ul><li>State-issued driver’s license number or ID card</li><li>Social Security numbers</li><li>Medical data</li><li>Financial data</li><li>Incomplete personal account number (PAN)/payment card information</li><li>Service code</li><li>Security code</li><li>Cardholder name</li><li>Service date</li></ul> |
| Additional Labeling for Restricted Data | <ul><li><b>PCI DSS</b>: Data and systems defined in the cardholder data environment</li><li><b>PCI DSS</b>: Full PAN</li><li><b>Administrative</b>: “Shared fate” administrative accounts or management consoles where attackers could easily gain access to technology management systems</li></ul>|

## Additional Reources

[PCI Security Standards Council Glossary](https://www.pcisecuritystandards.org/glossary/)

[PCI Standards Overview](https://www.pcisecuritystandards.org/standards/)