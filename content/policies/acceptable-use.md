...
description: "Rules governing use of company IT systems, networks, data, and equipment"
date: 2026-01-01
weight: 20
taxonomies:
  SCF:
...
- {{ org() }} may require the remote wipe of company data from your personal device if it is lost, stolen, or upon your departure
- {{ org() }} will not access personal data on your device beyond what is technically required to manage the company's data
...
{{ org() }} reserves the right to monitor use of company systems and networks to the extent permitted by applicable law. This includes:
