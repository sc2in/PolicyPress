...
This Acceptable Use Guidelines policy ("Policy") outlines unacceptable use of {{ config.extra.organization }} Software-as-a-Service (SaaS), Platform-as-a-Service (PaaS), or any other offering of {{ config.extra.organization }}, which interact with, or access, the Internet (the "Services"). This Policy is in addition to any other terms and conditions under which {{ config.extra.organization }} provides the Services to you.

{{ config.extra.organization }} may make reasonable modifications to this Policy from time to time by posting a new version of this document in the {{ config.extra.organization }} Trust Center . Revisions are effective immediately upon posting. Accordingly, we recommend that you visit the {{ config.extra.organization }} website regularly to ensure that your activities conform to the most recent version.

Questions about this Policy (e.g., whether any contemplated use is permitted) and reports of violations of this Policy should be directed to {{ config.extra.organization }}'s helpdesk.

## Acceptable Behavior

You are solely responsible for your conduct and your data related to the Services. The Services are made available to you, your company, and/or your customers only for personal or commercial use, which use must be in compliance with all applicable laws, rules and regulations, and must not infringe or violate third party rights.

## Unacceptable Behavior

The examples listed in this Policy are not exhaustive. Prohibited uses and activities include, without limitation, any use of the Services in a manner that, in {{ config.extra.organization }}' reasonable judgment, involves, facilitates, or attempts any of the following:
...
- Holding {{ config.extra.organization }} or its affiliates up to public scorn or ridicule; and/or
- Reselling {{ config.extra.organization }}' services, in whole or in part, to any entity or individual, without {{ config.extra.organization }}' prior written consent, or misrepresenting your relationship with {{ config.extra.organization }}

### Disruption

- Obtaining unauthorized access to any system, network, service, or account
- Any behavior:
  - Compromising the integrity of the Services to include, but not limited to, probing, scanning, and/or testing the vulnerability of any system or network which hosts the {{ config.extra.organization }}' Services, without prior explicit authorization from {{ config.extra.organization }}
...
You may be asked by {{ config.extra.organization }} to bring the offending or breaching materials in compliance with this Policy. Any costs incurred by you in conjunction with this shall be borne solely by you and your company.
