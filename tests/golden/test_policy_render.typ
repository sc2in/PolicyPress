...
#page(
  ...
  #heading(level: 1, outlined: false)[#text(size: 36pt, weight: "bold")[Render Test Policy]]
...
== Purpose
Star City Security Consulting uses this policy to verify that PDF rendering works end-to-end.
